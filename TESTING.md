...
- [ ] **Pending:** Fill enough annotations to scroll the floating list; confirm its header and Send button remain sticky. Send without composer text and verify Change annotations prefer targeted edit calls, Questions receive answers, and the one-shot snapshot/queue behavior remains intact.
