...
// src/plugin/settings-tab.mjs
var PiAgentSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(containerEl).setName("Pi CLI").setHeading();
    new import_obsidian5.Setting(containerEl)
    ...
    new import_obsidian5.Setting(containerEl).setName("Skills").setHeading();
    new import_obsidian5.Setting(containerEl)
    ...
    new import_obsidian5.Setting(containerEl).setName("Context and file access").setHeading();
    new import_obsidian5.Setting(containerEl)
...
// src/ui/modals/approval-modal.mjs
var ApprovalModal = class extends import_obsidian6.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian6.Setting(contentEl).setName("Approve vault change").setHeading();
  ...
  async applyChange() {
    ...
    new import_obsidian6.Notice(`Applied Pi change to ${this.change.path}`);
  }
  finish() {
    if (this.settled) return;
    this.settled = true;
...
var PiSetupModal = class extends import_obsidian7.Modal {
  ...
  onOpen() {
    const { contentEl } = this;
    contentEl.empty();
    new import_obsidian7.Setting(contentEl).setName("Set up Pi CLI").setHeading();
...
${message.content}`)
  ...
  async copyResponse(content) {
    ...
    new import_obsidian8.Notice("Copied response.");
  }
};
...
var NoteActions = class {
  ...
  async openCitedNotes(text) {
    ...
    if (links.length === 0) {
      new import_obsidian9.Notice("No vault links found.");
      return;
    }
...
function normalizeArchiveFolder(folder) {
  return (0, import_obsidian9.normalizePath)(normalizeVaultFolder(folder, "Pi"));
}
...
var RunSettingsControls = class {
    ...
    this.addRunSetting(
      ...
      async (value) => {
        ...
        if (value === CUSTOM_MODEL_VALUE && !this.plugin.settings.customModel) {
          new import_obsidian10.Notice("Set custom model ID in plugin settings.");
        }
        await this.plugin.saveSettings();
        this.refresh();
      }
  ...
  addRunSetting(containerEl, name, icon, options, value, onChange) {
    ...
    (0, import_obsidian10.setIcon)(buttonEl, icon);
  ...
  forkChat() {
    this.plugin.forkCurrentThread()
      ? (this.callbacks.resetThreadUiState?.(),
        ...
        this.callbacks.renderMessages(),
        this.callbacks.renderToolBadges?.())
      : new import_obsidian11.Notice("Nothing to fork yet.");
  }
};
